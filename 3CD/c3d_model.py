# -*- coding: utf-8 -*-
"""
Created on Tue Jun 19 16:39:37 2018
...
def get_model(summary=False, backend='tf'):
    ...
    model.add(Convolution3D(512, 3, 3, 3, activation='relu',
                            border_mode='same', name='conv6'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), strides=(2, 2, 2),
                           border_mode='valid', name='pool4'))

    # 5th layer group
    model.add(Convolution3D(512, 3, 3, 3, activation='relu',
                            border_mode='same', name='conv7'))
    model.add(Convolution3D(512, 3, 3, 3, activation='relu',
                            border_mode='same', name='conv8'))
...
def get_int_model(model, layer, backend='tf'):
    ...
    if layer == 'conv8':
        return int_model
    int_model.add(MaxPooling3D(pool_size=(2, 1, 1), strides=(2, 1, 1),
                           border_mode='valid', name='pool5'))
